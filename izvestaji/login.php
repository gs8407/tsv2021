...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["username"]))) {
        $username_err = "Unesite svoje korisničko ime.";
    } else {
    ...
    if (empty(trim($_POST["password"]))) {
        $password_err = "Unesite svoju šifru.";
    } else {
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        $sql = "SELECT JAVNA, NAZIV, IME, SIFRA, OVLASCENJE FROM korisnik WHERE NAZIV = ?";
        ...
        if ($stmt = mysqli_prepare($conn, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    ...
                    mysqli_stmt_bind_result($stmt, $javna, $naziv, $ime, $hashed_password, $ovlascenje);
                    if (mysqli_stmt_fetch($stmt)) {
                        if ($password === $hashed_password) {
                            // Password is correct
                            // Store data in session variables
                            $_SESSION["loggedin"] = true;
                            $_SESSION["javna"] = $javna;
        ...
        <div class="card card-container">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="form-group mt-4">
                    <input type="submit" class="btn btn-primary" value="Pristupi">
                </div>
